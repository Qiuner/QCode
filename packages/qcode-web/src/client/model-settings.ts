...
import type { QCodeLocaleKey, QCodeTranslate } from './locales.js'

const MODEL_ERROR_KEYS: Record<string, QCodeLocaleKey> = {
...
export function localizedModelError(reason: unknown, t: QCodeTranslate): string {
