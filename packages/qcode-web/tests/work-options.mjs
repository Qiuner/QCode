  ...
  for (const width of [1280, 390]) {
    ...
    try {
      await page.setContent(`<style>${WORLD_STYLES}
        ...
        [data-qcode-town] [data-slot="conversation"] { position: fixed; inset: 250px 0 150px; z-index: 21; visibility: visible; pointer-events: auto; background: white; }
      </style><div data-qcode-town>
