...
Start with the requirements, quick start, and current limitations in the [README](README.md), plus the [desktop launcher guide](apps/desktop/README.en.md). Running from source requires a supported Node.js version, Corepack, Yarn, and the complete Git submodule checkout.
...
Do not report vulnerabilities or issues containing sensitive information publicly. Follow the [Security Policy](SECURITY.en.md) and use the private reporting channel.
