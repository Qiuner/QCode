...
- **开发新岛屿**：先看[岛屿与插件开发指南](../packages/qcode-web/docs/plugin-development.md)，再看[岛屿接入契约](world-integration-contract.md)。
...
| [岛屿与插件开发指南](../packages/qcode-web/docs/plugin-development.md) | 新增岛屿、Host / Client 插件的开发路径与最小交付物 |
| [文档维护指南](documentation-guide.md) | 文档分类、状态标记、证据位置与更新规则 |
| [QCode 重命名施工](qcode-renaming-plan.md) | 产品、内部标识、兼容迁移、仓库与发布入口的分阶段重命名方案 |
| [网页优先 MVP](qcode-mvp-plan.md) | 当前最小业务闭环 |
...
- `deepseek-harness/` 是固定版本的上游源码，其文档不属于 QCode 文档。
